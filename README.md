...
1. [Example Models](#example-models)
1. [Demo](#demo)
1. [Appendix](#appendix)
...
The quantity of GPU depends on how many models to deploy concurrently.
...
*Note*: This has not been fully verified yet.
...
This depends on the region, use case, and the availability of GPUs type. 

### Full Weight Model

| ID | Model Card | Type | Parameters (B) | Model Weight Size (GB) |
| :---- | :---- | :---- | :---- | :---- |
| 1 |  |  |  |  |
| 2 |  |  |  |  |
| 3 | Qwen2.5/VL / … | Vision |  |  |
...
![whisper-chat](images/whisper-chat.png)
...
Red Hat validated and optimized models on [Hugging Face](https://huggingface.co/RedHatAI).
